                        ...
                        <div class="table-wrapper">
                            <div class="table-title">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <a href="\view\contract\create.jsp" class="btn btn-success"><i
                                ...
                                <c:forEach var="Contract" items="${contractList}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div id="listContractDetailModal${Contract.id}" class="modal fade"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <table class="table table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                <c:forEach var="ContractDetail"
                                                                           items="${contractDetailList}"
                                                                           varStatus="status">
                                                                    <c:forEach var="AttachFacility"
                                                                               items="${attachFacilityList}">
