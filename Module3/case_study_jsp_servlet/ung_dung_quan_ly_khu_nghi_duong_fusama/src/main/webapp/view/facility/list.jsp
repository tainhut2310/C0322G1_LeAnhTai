                ...
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <a href="#addFacilityModal" class="btn btn-success" data-toggle="modal"><i
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="update.jsp" class="edit"><i class="material-icons"
                                                                     data-toggle="tooltip"
                                                                     title="Edit">&#xE254;</i></a>
                                <a href="#deleteFacilityModal" class="delete" data-toggle="modal"><i
                        ...
                        <tr>
                            ...
                            <td>(313) 555-5735</td>
                            <td>
                                <a href="#editFacilityModal" class="edit" data-toggle="modal"><i class="material-icons"
                                                                                                 data-toggle="tooltip"
                                                                                                 title="Edit">&#xE254;</i></a>
                                <a href="#deleteFacilityModal" class="delete" data-toggle="modal"><i
                                        class="material-icons"
